...
func TestGetOperandStackDeltaDepth(t *testing.T) {
	cases := []struct {
		...
		},
		{
			name: "single_GetArg",
			insts: []ir.Instruction{
				ir.NewInstruction([]byte("0"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
			},
			want: []int{0, 1},
		},
		{
			...
			insts: []ir.Instruction{
				ir.NewInstruction([]byte("0"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
				ir.NewInstruction([]byte("1"), ir.OpGetFeed, ir.ImmNum(1), ir.Nothing()),
			},
			want: []int{0, 1, 2},
		},
		{
		...
		},
		{
			...
			insts: []ir.Instruction{
				ir.NewInstruction([]byte("0"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
				ir.NewInstruction([]byte("1"), ir.OpGetFeed, ir.ImmNum(1), ir.Nothing()),
				ir.NewInstruction([]byte("2"), ir.OpGetFeed, ir.ImmNum(2), ir.Nothing()),
...
func TestResolveOperandsOrderFromSourceCode(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			source: "feed(0);",
			want: []ir.Instruction{
				ir.NewInstruction([]byte("00"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
			},
		},
		{
			name:   "add_no_reorder",
			...
			want: []ir.Instruction{
				ir.NewInstruction([]byte("00"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
				ir.NewInstruction([]byte("01"), ir.OpGetFeed, ir.ImmNum(1), ir.Nothing()),
		...
		},
		{
			...
			want: []ir.Instruction{
				ir.NewInstruction([]byte("05"), ir.OpGetFeed, ir.ImmNum(3), ir.Nothing()),
				ir.NewInstruction([]byte("03"), ir.OpGetFeed, ir.ImmNum(2), ir.Nothing()),
				ir.NewInstruction([]byte("01"), ir.OpGetFeed, ir.ImmNum(1), ir.Nothing()),
				ir.NewInstruction([]byte("00"), ir.OpGetFeed, ir.ImmNum(0), ir.Nothing()),
				ir.NewInstruction([]byte("02"), ir.OpSubtract, ir.RefTo([]byte("00")), ir.RefTo([]byte("01"))),
		...
		},
		{
			...
			source: "1 - 2 / 2 - 1;",
			want: []ir.Instruction{
				ir.NewInstruction([]byte("05"), ir.OpSave, ir.ImmNum(1), ir.Nothing()),
				ir.NewInstruction([]byte("02"), ir.OpSave, ir.ImmNum(2), ir.Nothing()),
				ir.NewInstruction([]byte("01"), ir.OpSave, ir.ImmNum(2), ir.Nothing()),
				ir.NewInstruction([]byte("03"), ir.OpDivide, ir.RefTo([]byte("01")), ir.RefTo([]byte("02"))),
				ir.NewInstruction([]byte("00"), ir.OpSave, ir.ImmNum(1), ir.Nothing()),
		...
		},
		{
			...
			want: []ir.Instruction{
				...
				ir.NewInstruction([]byte("00"), ir.OpSave, ir.ImmNum(6), ir.Nothing()),
				ir.NewInstruction([]byte("04"), ir.OpSubtract, ir.RefTo([]byte("00")), ir.RefTo([]byte("03"))),
				ir.NewInstruction([]byte("06"), ir.OpSubtract, ir.RefTo([]byte("04")), ir.RefTo([]byte("05"))),
			},
		},
