...
export const Terminals: [RegExp, TokenTag][] = [
  ...
  [new RegExp(/^nth/), TokenTag.CALL_NTH],
  [new RegExp(/^str->num/), TokenTag.CALL_STR_TO_NUM],
  ...
  [new RegExp(/^let/), TokenTag.LET],
  [new RegExp(/^=/), TokenTag.SETTER],
